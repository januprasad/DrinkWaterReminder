package com.github.januprasad.drinkwater.util
...
import com.github.januprasad.drinkwater.CHANNEL
import com.github.januprasad.drinkwater.R
...
class ReminderReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            DONE -> {
                runBlocking { updateUseCase.invoke(reminder.copy(done = true)) }
